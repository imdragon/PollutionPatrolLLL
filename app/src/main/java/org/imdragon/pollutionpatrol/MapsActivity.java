...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    private void setUpMap() {
        ...
        myMap.addMarker(new MarkerOptions().position(new LatLng(34.411676, -119.846793)).snippet("Test").title("Test Title"));
        myMap.addMarker(new MarkerOptions().position(new LatLng(35.411676, -119.846793)).snippet("AnotherTest").title("Yada"));
        myMap.addMarker(new MarkerOptions().position(new LatLng(45.411676, -179.846793)).snippet("Random Point").title("Woohoo"));
